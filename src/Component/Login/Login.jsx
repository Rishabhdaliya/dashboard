                ...
                <form className="space-y-4 md:space-y-6" action="#">
                  <div>
                    ...
                    <input
                      ...
                      name="email"
                      id="email"
                      className=" border sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
